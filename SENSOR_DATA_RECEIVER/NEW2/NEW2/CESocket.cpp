...
CCESocket::~CCESocket()
{
	...
	OutputDebugString(_T("CCESocket::~CCESocket()  Wait Until ReadThread Exit\n"));
	...
	watchDog = 0;
	OutputDebugString(_T("CCESocket::~CCESocket() ReadThread Exit\n"));
	...
	OutputDebugString(_T("CCESocket::~CCESocket() AcceptThread Exit\n"));
...
int CCESocket::Send(CString& str)
{
	...
	sprintf_s(buf, 256, "%s", str.GetBuffer(0)); str.ReleaseBuffer();
//	wcstombs(buf, strBuf, 256);
...
void CCESocket::AcceptThread()
{
	...
	do 
	{
		...
		OutputDebugString(_T("On Accept\n"));
	...
	OutputDebugString(_T("Accept Thread Eixt\n"));
	////////////////////////////////////////////////////////////////////////////////////
...
//	delete[] buf;
	...
	m_readThreadState = CLOSED;
	m_readThread = NULL;
	OutputDebugString(_T("Read Thread while out\n"));
	// ExitThread(WM_QUIT);
}
